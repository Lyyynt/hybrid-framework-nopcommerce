...
public class Grid_04_Remote_Computer_BrowserStack extends BaseTest{
	...
	public void beforeClass(String url, String osName, String osVersion, String browserName, String browserVersion) {
		driver = getBrowserDriverWithStackBrowser(url, osName, osVersion, browserName, browserVersion);
		firstName = "Tony";
		lastName = "Buoi Sang";
