...
public class Grid_03_Remote_Computer_Apply_Framwork extends BaseTest{
	...
	@BeforeClass
	public void beforeClass(String browserName, String url, String ipAddress, String portNumber) {
		driver = getBrowserDriverGrid(browserName, url, ipAddress, portNumber);
		firstName = "Tony";
		lastName = "Buoi Sang";
