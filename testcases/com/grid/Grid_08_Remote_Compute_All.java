...
public class Grid_08_Remote_Compute_All extends BaseTest{
	String projectFolder = System.getProperty("user.dir");
	WebDriver driver;
	Select select;
	String firstName, lastName, email, companyName, password;
	
	@Parameters({"serverName", "runEnvironmentName", "browserName", "browserVersion", "osName", "osVersion", "ipAddress", "portNumber"})
	@BeforeClass
	public void beforeClass(@Optional("dev") String serverName, 
			@Optional("local") String runEnvironmentName, 
			@Optional("chrome") String browserName, 
			@Optional("87.0") String browserVersion, 
		...
		driver = getBrowserDriver(serverName, runEnvironmentName, browserName, browserVersion, osName, osVersion, ipAddress, portNumber);
		firstName = "Tony";
		lastName = "Buoi Sang";
