...
public class Grid_06_Remote_Computer_CrossBrowserTesting extends BaseTest{
	...
	@BeforeClass
	public void beforeClass(String url, String osName, String browserName) {
		driver = getBrowserDriverWithCrossBrowserTesting(url, osName, browserName);
		firstName = "Tony";
		lastName = "Buoi Sang";
