...
public class Grid_05_Remote_Computer_SourceLab extends BaseTest{
	String projectFolder = System.getProperty("user.dir");
	WebDriver driver;
	Select select;
	String firstName, lastName, email, companyName, password;
	
	@Parameters({"url", "os", "browser", "browser_version"})
	@BeforeClass
	public void beforeClass(String url, String osName, String browserName, String browserVersion) {
		driver = getBrowserDriverWithSourceLab(url, osName, browserName, browserVersion);
		firstName = "Tony";
		lastName = "Buoi Sang";
