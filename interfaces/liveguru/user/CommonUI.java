...
public class CommonUI {
	...
	public static final String DYNAMIC_SKIP_LINK_BY_LABEL = "xpath=//div[@class='skip-links']//span[text()='%s']";
	...
	public static final String DYNAMIC_BUTTON_IN_MINICART = "xpath=//div[@class='minicart-wrapper']//a[contains(text(), '%s')]";
}
